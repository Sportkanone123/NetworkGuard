...
public class ConfigManager {
    private static final Plugin plugin = NetworkGuard.plugin ;
    ...
    public static void loadConfig(String string) throws IOException {
        ...
        if(!file.exists()){
            ...
            try{
                ...
                System.out.println("[NetworkGuard] Error loading files, please contact the developer and send him this stacktrace:");
                e.printStackTrace();
            }
        }else{
            FileConfiguration configuration = new YamlConfiguration();
    ...
    public static void saveConfig(String string){
        try {
            ...
            System.out.println("[NetworkGuard] Error saving files, please contact the developer and send him this stacktrace:");
            e.printStackTrace();
        }
    }
